...
export default function SimulatorPanel({ spacesTotal, spacesAvailable, simulationButtonsDisabled, carriedCar, parkingLotConfiguration, parkingLogs, simulationOn, debugMode, toggleDebugMode, toggleSimulation }) {
